  ...
  <nav class="px-nav px-nav-left">
    ...
    <ul class="px-nav-content">
      <li class="px-nav-item px-nav-dropdown">
        <a href="#"><i class="px-nav-icon ion-ios-home"></i><span class="px-nav-label">Surat Unit</span></a>
        <ul class="px-nav-dropdown-menu">
          <li class="px-nav-item {{Request ::segment(2) == 'arsip'?'active' : '' }}"><a href="/adminunit/arsip"><span class="px-nav-label">Daftar Surat Unit</span></a></li>
        </ul>
      </li>
      <li class="px-nav-item px-nav-dropdown">
        <a href="#"><i class="px-nav-icon ion-ios-home"></i><span class="px-nav-label">Surat</span></a>
        <ul class="px-nav-dropdown-menu">
          <li class="px-nav-item {{Request ::segment(3) == 'surat'?'active' : '' }}"><a href="/adminunit/user/surat"><span class="px-nav-label">Daftar Surat Anda</span></a></li>
        </ul>
      </li>
        <ul class="px-nav-dropdown-menu">
      ...
      <li class="px-nav-item px-nav-dropdown">
        ...
        <ul class="px-nav-dropdown-menu">
          <li class="px-nav-item {{Request ::segment(3) == 'report'?'active' : '' }}"><a href="/adminunit/user/report"><span class="px-nav-label">Data Surat Penugasan</span></a></li>
        </ul>
      </li>
      <li class="px-nav-item px-nav-dropdown">
        <a href="#"><i class="px-nav-icon ion-clipboard"></i><span class="px-nav-label">Halo, <b>{{session()->get('name')}}</b></span></a>
        <ul class="px-nav-dropdown-menu">
          <li class="px-nav-item"><a href="/adminunit/data/pegawai/{{session()->get('nomor')}}"><span class="px-nav-label">Data Diri</span></a></li>
        </ul>
        <ul class="px-nav-dropdown-menu">
