...
<form class="form-horizontal" method="post">
  <div class="form-group">
    ...
    <div class="col-md-9">
      <input type="text" class="form-control" id="grid-input-1" name="nim" placeholder="Nomor Induk Pegawai" value="{{ isset($inputdata->nip)? $inputdata->nip : '' }}">
    </div>
  </div>
  <div class="form-group">
 ...
 <div class="form-group">
  ...
  <div class="col-md-9">
    <input type="text" class="form-control" name="jabatan" id="jabatan" placeholder="Jabatan" value="{{ isset($inputdata->jabatan) ? $inputdata->jabatan: '' }}">
  </div>
</div>
<div class="form-group">
...
<div class="form-group">
 ...
 <div class="col-md-3">
   <input type="text" class="form-control" name="status" id="status" value="{{ isset($inputdata->status) ? $inputdata->status : '' }}">
 </div>
</div>
<div class="form-group">
 <label for="jk" class="col-md-3 control-label">Unit</label>
 <div class="col-md-3">
   <input type="text" class="form-control" name="unit" id="unit" value="{{ isset($inputdata->unit) ? $inputdata->unit : '' }}">
 </div>
</div>
<div class="form-group">
  <label for="form-inline-input-1" class="col-md-3 control-label">Password</label>
  <div class="col-md-9">
    <input type="password" class="form-control" id="grid-input-1" name="password" placeholder="Password" value="123456">
  </div>
</div>
<div class="form-group">
...
<script type="text/javascript">
 $(function() {
  ...
  $('#status').select2({
    ...
    data: [{"id":"User", "text" : "Individu"},{"id":"Admin", "text" : "Admin"}, {"id":"AdminUnit", "text" : "Admin Unit"}]
  });
  $('#unit').select2({
